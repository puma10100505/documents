...
/////////////////////////////////////////////////////////////////////
int32_t SessionManager::sid_seq = 0;

void SessionManager::AddSession(uint32_t sid, const Session& sess)
{
    session_list[sid] = sess;
}
...
Session* SessionManager::CreateSession(int64_t guid)
{
    ...
    session_list[SessionManager::sid_seq] = new_s;
